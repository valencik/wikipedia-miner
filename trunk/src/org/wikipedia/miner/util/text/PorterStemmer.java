...
public class PorterStemmer extends TextProcessor {  
	...
	public String processText(String text) {
		...
		for (String term: terms) {
			if (term != "") 
				processedText = processedText + " " + cleaner.processText(stem(term)) ;
		}
	...
	/**
	 * Convenience method for stemming a string.
	 * 
	 * @param word the string to stem
	 * @return the root (stem) of the argument word.
	 */
	 ...
	 *
	 * @param args	the names or paths of the files to be processed.
	 */
