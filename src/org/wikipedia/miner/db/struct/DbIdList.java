...
public class DbIdList extends org.apache.hadoop.record.Record {
  ...
  static {
    _rio_recTypeInfo = new org.apache.hadoop.record.meta.RecordTypeInfo("DbIdList");
    _rio_recTypeInfo.addField("Ids", new org.apache.hadoop.record.meta.VectorTypeID(org.apache.hadoop.record.meta.TypeID.IntTypeID));
  }
  
  private java.util.ArrayList<Integer> Ids;
  public DbIdList() { }
  public DbIdList(
    final java.util.ArrayList<Integer> Ids) {
    this.Ids = Ids;
  }
  ...
  public void setIds(final java.util.ArrayList<Integer> Ids) {
    this.Ids=Ids;
  }
  ...
  throws java.io.IOException {
    ...
    {
      _rio_a.startVector(Ids,"Ids");
      int _rio_len1 = Ids.size();
      for(int _rio_vidx1 = 0; _rio_vidx1<_rio_len1; _rio_vidx1++) {
        int _rio_e1 = Ids.get(_rio_vidx1);
        _rio_a.writeInt(_rio_e1,"_rio_e1");
      }
      _rio_a.endVector(Ids,"Ids");
    }
  ...
  throws java.io.IOException {
    ...
    {
      org.apache.hadoop.record.Index _rio_vidx1 = _rio_a.startVector("Ids");
      Ids=new java.util.ArrayList<Integer>();
      for (; !_rio_vidx1.done(); _rio_vidx1.incr()) {
        int _rio_e1;
        _rio_e1=_rio_a.readInt("_rio_e1");
        Ids.add(_rio_e1);
      }
      _rio_a.endVector("Ids");
    }
  ...
  public int compareTo (final Object _rio_peer_) throws ClassCastException {
    if (!(_rio_peer_ instanceof DbIdList)) {
      throw new ClassCastException("Comparing different types of records.");
    }
    DbIdList _rio_peer = (DbIdList) _rio_peer_;
    int _rio_ret = 0;
    {
      int _rio_len11 = Ids.size();
      int _rio_len21 = _rio_peer.Ids.size();
      for(int _rio_vidx1 = 0; _rio_vidx1<_rio_len11 && _rio_vidx1<_rio_len21; _rio_vidx1++) {
        int _rio_e11 = Ids.get(_rio_vidx1);
        int _rio_e21 = _rio_peer.Ids.get(_rio_vidx1);
  ...
  public boolean equals(final Object _rio_peer_) {
    ...
    _rio_ret = Ids.equals(_rio_peer.Ids);
    if (!_rio_ret) return _rio_ret;
    return _rio_ret;
  }
  public Object clone() throws CloneNotSupportedException {
    DbIdList _rio_other = new DbIdList();
    _rio_other.Ids = (java.util.ArrayList<Integer>) this.Ids.clone();
    return _rio_other;
  }
  public int hashCode() {
    int _rio_result = 17;
    int _rio_ret;
    _rio_ret = Ids.hashCode();
  ...
  static {
    org.apache.hadoop.record.RecordComparator.define(DbIdList.class, new Comparator());
  }
}
