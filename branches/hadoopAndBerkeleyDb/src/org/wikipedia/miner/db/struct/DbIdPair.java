...
public class DbIdPair extends org.apache.hadoop.record.Record {
  ...
  static {
    _rio_recTypeInfo = new org.apache.hadoop.record.meta.RecordTypeInfo("DbIdPair");
    _rio_recTypeInfo.addField("IdA", org.apache.hadoop.record.meta.TypeID.IntTypeID);
    _rio_recTypeInfo.addField("IdB", org.apache.hadoop.record.meta.TypeID.IntTypeID);
  }
  ...
  public int compareTo (final Object _rio_peer_) throws ClassCastException {
    if (!(_rio_peer_ instanceof DbIdPair)) {
      throw new ClassCastException("Comparing different types of records.");
    }
    DbIdPair _rio_peer = (DbIdPair) _rio_peer_;
    int _rio_ret = 0;
    _rio_ret = (IdA == _rio_peer.IdA)? 0 :((IdA<_rio_peer.IdA)?-1:1);
    if (_rio_ret != 0) return _rio_ret;
    _rio_ret = (IdB == _rio_peer.IdB)? 0 :((IdB<_rio_peer.IdB)?-1:1);
    if (_rio_ret != 0) return _rio_ret;
    return _rio_ret;
  }
  public boolean equals(final Object _rio_peer_) {
    ...
    _rio_ret = (IdA==_rio_peer.IdA);
    if (!_rio_ret) return _rio_ret;
    _rio_ret = (IdB==_rio_peer.IdB);
    if (!_rio_ret) return _rio_ret;
    return _rio_ret;
  }
  public Object clone() throws CloneNotSupportedException {
    DbIdPair _rio_other = new DbIdPair();
    _rio_other.IdA = this.IdA;
    _rio_other.IdB = this.IdB;
    return _rio_other;
  }
  public int hashCode() {
    int _rio_result = 17;
  ...
  static {
    org.apache.hadoop.record.RecordComparator.define(DbIdPair.class, new Comparator());
  }
}
