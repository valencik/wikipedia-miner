...
public abstract class TextProcessor {
	 ...
	 * name of the class.
     * The name should be less than MAX_ID_LENGTH characters long.
	 * 
	...
	/**
	 * Returns a string that identifies this TextProcessor. It should provide complete information
     * to setup the text processor. The default is to return the canonical name of the class.
	 *
	 * @return	the textual description of the TextProcessor.
	 */
    @Override
